...
def get_options(args=None):
    ...
    parser.add_argument('--val_graph_size', type=int, default=8, help="The size of the problem graph")
    ...
    parser.add_argument('--n_epochs', type=int, default=501, help='The number of epochs to train')
