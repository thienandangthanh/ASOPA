...
def get_options(args=None):
    ...
    parser.add_argument(
        "--problem", default="noop", help="The problem to solve, default 'tsp'"
    )
    parser.add_argument(
        "--graph_size", type=int, default=10, help="The size of the problem graph"
    )
    parser.add_argument(
        "--val_graph_size", type=int, default=8, help="The size of the problem graph"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
        default=64,
        help="Number of instances per batch during training, default 64",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=128,
        help="Dimension of input embedding, default 128",
    )
    parser.add_argument(
        "--hidden_dim",
        type=int,
        default=128,
        help="Dimension of hidden layers in Enc/Dec, default 128",
    )
    parser.add_argument(
        "--n_encode_layers",
        type=int,
    ...
    parser.add_argument(
        ...
        type=float,
        default=lr,
        help="Set the learning rate for the actor network 1e-4",
    )
    parser.add_argument(
        "--lr_critic",
        type=float,
