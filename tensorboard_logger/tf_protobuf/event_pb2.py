...
from tensorboard_logger.tf_protobuf import (
    summary_pb2 as tensorboard__logger_dot_tf__protobuf_dot_summary__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        tensorboard__logger_dot_tf__protobuf_dot_summary__pb2.DESCRIPTOR,
    ],
)
...
_EVENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="wall_time",
            full_name="tensorflow.Event.wall_time",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="step",
            full_name="tensorflow.Event.step",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="file_version",
            full_name="tensorflow.Event.file_version",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="graph_def",
            full_name="tensorflow.Event.graph_def",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="summary",
            full_name="tensorflow.Event.summary",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="log_message",
            full_name="tensorflow.Event.log_message",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="session_log",
            full_name="tensorflow.Event.session_log",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tensorflow.Event.tagged_run_metadata",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="what",
            full_name="tensorflow.Event.what",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_LOGMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="tensorflow.LogMessage.message",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SESSIONLOG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="tensorflow.SessionLog.status",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="tensorflow.SessionLog.checkpoint_path",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="tensorflow.SessionLog.msg",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_TAGGEDRUNMETADATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="tag",
            full_name="tensorflow.TaggedRunMetadata.tag",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="run_metadata",
            full_name="tensorflow.TaggedRunMetadata.run_metadata",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_EVENT.fields_by_name["summary"].message_type = (
    tensorboard__logger_dot_tf__protobuf_dot_summary__pb2._SUMMARY
)
