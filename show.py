...
def show_speed_performance_dataset(dataset):
    ...
    performance_percent_his = defaultdict(list)
    # 对比算法 top15个数存储
    top15_his = {}
    for name in methods:
    ...
    sio.savemat('./performance_percent/n%d_performance_percent_%d_duibi.mat' % (user_num, len(top15_list)),
                {'performance_percent': performance_percent_his})
